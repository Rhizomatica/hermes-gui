...
export class GlobalConstants {
  ...
  public static apiURL = environment.local ? 'https://10.8.0.127/api' : `https://${self.location.hostname + '/api'}`
  public static webSocketUrl = environment.local ? 'wss://10.8.0.127:8080/websocket' : `wss://${self.location.hostname + ':8080/websocket'}`
